...
//
// Run: swift test-fixtures/test-ios-performance-parity.swift

import Foundation

let repoRoot = URL(fileURLWithPath: FileManager.default.currentDirectoryPath)
let contentURL = repoRoot.appendingPathComponent("MarkdownReaderApp/Features/Reader/ContentView.swift")
