...
let cacheURL = repoRoot.appendingPathComponent("MarkdownReaderMac/Models/MarkdownImageCache.swift")
let readerURL = repoRoot.appendingPathComponent("MarkdownReaderMac/Features/Reader/ReaderSurface.swift")
let exportURL = repoRoot.appendingPathComponent("MarkdownReaderMac/Features/Export/ExportRunner.swift")
let projectURL = repoRoot.appendingPathComponent("MarkdownReaderMac.xcodeproj/project.pbxproj")
